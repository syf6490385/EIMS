...
public class BadgerImageView extends ImageView {
     ...
     */
	public BadgerImageView(Context context, View target) 
	{
     ...
     */
	public BadgerImageView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public BadgerImageView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public BadgerImageView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
	...
	private void applyLayoutParams() {
		...
		FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(25,25);
